...
namespace Lab_Ass4_7
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            bookshelf.AddBook("Gumshuda", "Khushi Varshney");
            bookshelf.AddBook("Khalifa", "Vaishnavi");
            bookshelf.AddBook("Front Page", "Payal Bansal");
            bookshelf.AddBook("Yagya", "Vandana");
            bookshelf.AddBook("Nimish", "Urvashi");
